...
function get_sets()
    ...
    back={ name="Conveyance Cape", augments={'Summoning magic skill +2','Pet: Enmity+12','Blood Pact Dmg.+3','Blood Pact ab. del. II -3',}},
}

	-- Fast Cast
	sets.precast.FC = {
	main={ name="Grioavolr", augments={'Blood Pact Dmg.+9','Pet: Mag. Acc.+16','Pet: "Mag.Atk.Bns."+21','DMG:+3',}},
    sub="Clerisy Strap",
    ammo="Impatiens",
    ...
    back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Mag. Acc+20 /Mag. Dmg.+20','Magic Damage +10','"Fast Cast"+10',}},
}
    ...
    sets.midcast["Refresh"] = set_combine(sets.midcast.Enhancing, {feet="Inspirited Boots",})
	...
	sets.midcast["Garland of Bliss"] = set_combine(sets.midcast.Nuke, {neck="Fotia Gorget", waist="Fotia Belt"})
    ...
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Blood Pact Dmg.+10','Pet: VIT+5','Pet: Mag. Acc.+11',}},
    ...
    back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Regen"+10','Pet: Damage taken -5%',}},
}
    ...
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+18','Blood Pact Dmg.+10','Pet: DEX+2','Pet: Mag. Acc.+13',}},
    legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
