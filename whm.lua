...
function init_gear_sets()
    ...
    sets.precast.FC = {
	main={ name="Grioavolr", augments={'"Fast Cast"+7','"Mag.Atk.Bns."+2','Magic Damage +2',}},
    sub="Vivid Strap",
    ammo="Incantor Stone",
    head="Nahtirah Hat",
    ...
    back={ name="Alaunus's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','"Cure" potency +10%','Phys. dmg. taken-10%',}},
	}
    ...
    sets.buff.Doom = {
        ...
        ring1={name="Haoma's Ring"}, --20
        ring2={name="Haoma's Ring"}, --20
